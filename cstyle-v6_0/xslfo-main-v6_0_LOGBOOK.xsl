...
-->
				<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="all-pages" page-height="9.5in" page-width="6.5in">
...
-->
				<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="chgrecpg-odd" page-height="9.5in" page-width="6.5in">
					<fo:region-body>
				...
				<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="chgrecpg-even" page-height="9.5in" page-width="6.5in">
					<fo:region-body>
...
-->
				<fo:simple-page-master margin-left=".75in" margin-right=".25in" master-name="frntrear-al-firstpage" page-height="9.5in" page-width="6.5in">
					<fo:region-body>
				...
				<fo:simple-page-master margin-left=".25in" margin-right=".75in" master-name="frntrear-al-even" page-height="9.5in" page-width="6.5in">
					<fo:region-body>
				...
				<fo:simple-page-master margin-left=".75in" margin-right=".25in" master-name="frntrear-al-odd" page-height="9.5in" page-width="6.5in">
					<fo:region-body>
...
-->
			<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="frntrear-rl-firstpage" page-height="9.5in" page-width="6.5in">
					<fo:region-body>
						<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+58"/>pt</xsl:attribute>
	...
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".35in" margin-top=".5in" master-name="frntrear-rl-odd" page-height="9.5in" page-width="6.5in">
					<fo:region-body>
						<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+58"/>pt</xsl:attribute>
						<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+36"/>pt</xsl:attribute>
					</fo:region-body>
			...
			<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="frntrear-rl-even" page-height="9.5in" page-width="6.5in">
					<fo:region-body>
						<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+58"/>pt</xsl:attribute>
						<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+36"/>pt</xsl:attribute>
					</fo:region-body>
...
-->
			<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="imtitlepg-odd" page-height="9.5in" page-width="6.5in">
				...
				<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="imtitlepg-even" page-height="9.5in" page-width="6.5in">
					<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5pc" margin-top="4pc" /> 
					<fo:region-before extent="4pc" region-name="xsl-region-before"/>
					<fo:region-after extent="5pc"  region-name="xsl-region-after"/>
				</fo:simple-page-master>
				<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="chap-toc-odd" page-height="9.5in" page-width="6.5in">
				...
				<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="chap-toc-even" page-height="9.5in" page-width="6.5in">
					<fo:region-body margin-bottom="3pc" margin-top="15pc" />
					<fo:region-before extent="15pc" region-name="chap-toc-before"/>
					<fo:region-after extent="3pc" region-name="chap-toc-after"/>
				</fo:simple-page-master>
...
<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="impg-odd-first" page-height="9.5in" page-width="6.5in">
		<xsl:choose>
	...
	<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="impg-even" page-height="9.5in" page-width="6.5in">
					<xsl:choose>
						<xsl:when test="*//@security = 'ts'">
								<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5.0pc" margin-top="4pc"/>
							<fo:region-before extent="5pc" region-name="impg-before"/>
	...
	<fo:simple-page-master margin-left=".75in" margin-right=".25in" margin-bottom=".5in" margin-top=".5in" master-name="impg-odd" page-height="9.5in" page-width="6.5in">
						<xsl:choose>
						<xsl:when test="*//@security = 'ts'">
								<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5.0pc" margin-top="4pc"/>
							<fo:region-before extent="5pc" region-name="impg-before"/>
			...
			<fo:simple-page-master margin-bottom=".25in" margin-left=".75in" margin-right=".25in" margin-top=".25in" master-name="emergpg-odd-first" page-height="9.5in" page-width="6.5in">
					<xsl:choose>
						<xsl:when test="*//@security = 'ts'">
							<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5.0pc" margin-top="4pc"/>
				...
				<fo:simple-page-master margin-bottom=".25in" margin-left=".25in" margin-right=".4in" margin-top=".15in" master-name="emergpg-even" page-height="9.5in" page-width="6.5in">
				<xsl:choose>
						<xsl:when test="*//@security = 'ts'">
								<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5.0pc" margin-top="4pc"/>
				...
				<fo:simple-page-master margin-left=".4in" margin-right=".25in" margin-bottom=".25in" margin-top=".15in" master-name="emergpg-odd" page-height="9.5in" page-width="6.5in">
				<xsl:choose>
						<xsl:when test="*//@security = 'ts'">
							<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5.0pc" margin-top="4pc"/>
...
<fo:simple-page-master margin-bottom="2pc" margin-left="3pc" margin-right="6pc" margin-top="2pc" master-name="blank-page-even" page-height="9.5in" page-width="6.5in">
		<fo:region-body region-name="xsl-region-body-blank">
		</fo:region-body>
		<fo:region-after region-name="xsl-region-after-blank" extent="0pt"/>
	</fo:simple-page-master>
	<fo:simple-page-master margin-bottom="2pc" margin-left="6pc" margin-right="3pc" margin-top="2pc" master-name="blank-page-odd" page-height="9.5in" page-width="6.5in">
		<fo:region-body region-name="xsl-region-body-blank">
		</fo:region-body>
		<fo:region-after region-name="xsl-region-after-blank" extent="0pt"/>
	</fo:simple-page-master>
...
-->
			...
			<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="loepwppg-first" page-height="9.5in" page-width="6.5in">
				...
				<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="loepwppg-recto" page-height="9.5in" page-width="6.5in">
		...
		<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="loepwppg-verso" page-height="9.5in" page-width="6.5in">
					<fo:region-body column-count="2" column-gap="10pt">
						<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+number($LOEPWP-SuperSize)+30"/>pt</xsl:attribute>
						<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+65"/>pt</xsl:attribute>
					</fo:region-body>
...
-->
				<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="titlepage-first-recto" page-height="9.5in" page-width="6.5in">
					<fo:region-body margin-bottom="8pc" margin-top="0pc">
						<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+65"/>pt</xsl:attribute>
					</fo:region-body>
					<fo:region-after extent="8pc" region-name="titlepg-first-after"/>
				</fo:simple-page-master>
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="titlepage-recto" page-height="9.5in" page-width="6.5in">
					<fo:region-body margin-bottom="7pc" margin-top="0pc"/>
					<fo:region-after extent="8pc" region-name="xsl-region-after"/>
				</fo:simple-page-master>
	<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="titlepage-verso" page-height="9.5in" page-width="6.5in">
...
-->
<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="tmcoverpg-recto-first" page-height="9.5in" page-width="6.5in">
					...
					<xsl:variable name="CoverFooterSize">
						<xsl:value-of select="number($AvailSize)+number($SuperSize)+number($DistribSize)+number($ExportSize)+number($DestrSize)+number($SecurSize)+160"/>pt</xsl:variable>
			...
			<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="tmcoverpg-recto" page-height="9.5in" page-width="6.5in">
...
-->
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="titleblkpg-recto-first" page-height="9.5in" page-width="6.5in">
					<xsl:variable name="AvailSize">
						<xsl:choose>
				...
				<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="titleblkpg-recto" page-height="9.5in" page-width="6.5in">
					<fo:region-body margin-bottom="3.5pc" margin-top="0pc"/>
					<fo:region-after extent="3.5pc" region-name="xsl-region-after"/>
				</fo:simple-page-master>
<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="titleblkpg-verso" page-height="9.5in" page-width="6.5in">
					<fo:region-body margin-bottom="3.5pc" margin-top="0pc"/>
					<fo:region-after extent="3.5pc" region-name="xsl-region-after"/>
				</fo:simple-page-master>
				<!--
