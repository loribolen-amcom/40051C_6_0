...
<?APT StylesheetID Title="U.S. Army MIL-STD-2361C XSL-FO" CompositionTypes="print,pdf,xsl"?>
         ...
         <xsl:when test="function-available('exslt:node-set')">
            <xsl:choose>
               ...
               <xsl:when test="$use-key='apply-templates-in-cleanup-nested-indexterms-mode'">
                  <xsl:apply-templates select="exslt:node-set($nodelist)" mode="cleanup-nested-indexterms"/>
               </xsl:when>
               ...
               <xsl:when test="$use-key='test-for-must-do-cleanup-nested-indexterms'">
                  <xsl:value-of select="string(boolean(exslt:node-set($nodelist)/*/_gte:XSLT-pass-control[1]/@must-cleanup-nested-indexterms))"/>
               </xsl:when>
               <xsl:otherwise/>
            </xsl:choose>
         </xsl:when>
...
<xsl:template match="processing-instruction('javax.xml.transform.disable-output-escaping')">
   ...
   <xsl:template match="processing-instruction('javax.xml.transform.enable-output-escaping')">
	...
	<xsl:include href="param-variable-v6_0.xsl"/>
	<xsl:include href="attribute-set-v6_0.xsl"/>
		<!--<xsl:include href="param.xsl"/> <xsl:include href="VERSION.xsl"/>
...
-->
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="all-pages" page-height="6.5in" page-width="9.5in" writing-mode="lr-tb" >
		<fo:region-body margin-bottom=".4in" margin-top=".5in"/>
...
-->
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="chgrecpg-odd" page-height="6.5in" page-width="9.5in">
		<fo:region-body>
	...
	<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="chgrecpg-even" page-height="6.5in" page-width="9.5in">
		<fo:region-body>
			<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+6"/>pt</xsl:attribute>
			<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)"/>pt</xsl:attribute>
		</fo:region-body>
		<fo:region-before display-align="before" region-name="xsl-region-before">
			<xsl:attribute name="extent"><xsl:value-of select="number($SecurHeaderFooterSize)"/>pt</xsl:attribute>
		...
		<fo:region-after display-align="after" region-name="xsl-region-after">
			<xsl:attribute name="extent"><xsl:value-of select="number($SecurHeaderFooterSize)+6"/>pt</xsl:attribute>
		</fo:region-after>
	</fo:simple-page-master>
	<!--
SIMPLE PAGE MASTER Front/Rear Arabic Lower
-->
	<fo:simple-page-master margin-left=".75in" margin-right=".25in" master-name="frntrear-al-firstpage" page-height="6.5in" page-width="9.5in">
		<fo:region-body>
			<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+36"/>pt</xsl:attribute>
			<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+30"/>pt</xsl:attribute>
		</fo:region-body>
		...
		<fo:region-after display-align="before" padding-bottom="1.5pc" region-name="frntrear-al-first-after">
			<xsl:attribute name="extent"><xsl:value-of select="number($SecurHeaderFooterSize)+30"/>pt</xsl:attribute>
		</fo:region-after>
	</fo:simple-page-master>
	
	<fo:simple-page-master margin-left=".25in" margin-right=".75in" master-name="frntrear-al-even" page-height="6.5in" page-width="9.5in">
		<fo:region-body>
			<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+36"/>pt</xsl:attribute>
			<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+30"/>pt</xsl:attribute>
		</fo:region-body>
...
<fo:simple-page-master margin-left=".75in" margin-right=".25in" master-name="frntrear-al-odd" page-height="6.5in" page-width="9.5in">
		<fo:region-body>
			<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+36"/>pt</xsl:attribute>
			<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+30"/>pt</xsl:attribute>
		</fo:region-body>
...
-->
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="frntrear-rl-firstpage" page-height="6.5in" page-width="9.5in">
		<fo:region-body>
			<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+60"/>pt</xsl:attribute>
			<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+30"/>pt</xsl:attribute>
		</fo:region-body>
	...
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".35in" margin-top=".5in" master-name="frntrear-rl-odd" page-height="6.5in" page-width="9.5in">
		<fo:region-body>
			<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+60"/>pt</xsl:attribute>
			<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+30"/>pt</xsl:attribute>
		</fo:region-body>
	...
	<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="frntrear-rl-even" page-height="6.5in" page-width="9.5in">
		<fo:region-body>
			<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+60"/>pt</xsl:attribute>
			<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+30"/>pt</xsl:attribute>
		</fo:region-body>
...
-->
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="imtitlepg-odd" page-height="6.5in" page-width="9.5in">
	...
	<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="imtitlepg-even" page-height="6.5in" page-width="9.5in">
		<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5pc" margin-top="4pc"/>
		<fo:region-before extent="4pc" region-name="xsl-region-before"/>
		<fo:region-after extent="5pc" region-name="xsl-region-after"/>
	</fo:simple-page-master>
	
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="chap-toc-odd" page-height="6.5in" page-width="9.5in">
		<fo:region-body margin-bottom=".4in" margin-top=".5in"/>
		<fo:region-before extent=".4in" region-name="chap-toc-before"/>
		<fo:region-after extent=".4in" region-name="chap-toc-after"/>
	</fo:simple-page-master>
	
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="chap-toc-even" page-height="6.5in" page-width="9.5in">
		<fo:region-body margin-bottom=".4in" margin-top=".5in"/>
		<fo:region-before extent=".4in" region-name="chap-toc-before"/>
		<fo:region-after extent=".4in" region-name="chap-toc-after"/>
	</fo:simple-page-master>
	
	<!-- SIMPLE PAGE MASTER FOR POCKET CHAPTER TITLE PAGES -->
	<fo:simple-page-master margin-bottom=".25in" margin-left=".4in" margin-right=".25in" margin-top=".15in" master-name="chp-odd-first" page-height="6.5in" page-width="9.5in">
		<fo:region-body column-count="2" column-gap="0.2in" margin-bottom=".25in" margin-top=".7in" padding-after="1.0pc" padding-before="1.0pc"/>
		<fo:region-before extent="1pc" region-name="chp-impg-before"/>
		<fo:region-after extent="1pc" padding-top="1.5pc" region-name="xsl-region-after-odd"/>
	</fo:simple-page-master>
	<fo:simple-page-master margin-bottom=".25in" margin-left=".25in" margin-right=".4in" margin-top=".15in" master-name="chp-even" page-height="6.5in" page-width="9.5in">
		<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="2pc" margin-top="2.5pc" padding-after="1.0pc" padding-before="1.0pc"/>
		<fo:region-before extent=".5pc" padding-after="1.5pc" region-name="xsl-region-before-even"/>
		<fo:region-after extent="1pc" padding-top="1.5pc" region-name="xsl-region-after-even"/>
	</fo:simple-page-master>
		<fo:simple-page-master margin-left=".4in" margin-right=".25in" margin-bottom=".25in" margin-top=".15in" master-name="chp-odd" page-height="6.5in" page-width="9.5in">
		<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="2pc" margin-top="2.5pc" padding-after="1.0pc" padding-before="1.0pc"/>
		<fo:region-before extent=".5pc" padding-after="1.5pc" region-name="xsl-region-before-odd"/>
		<fo:region-after extent="1pc" padding-top="1.5pc" region-name="xsl-region-after-odd"/>
	</fo:simple-page-master>
...
SIMPLE PAGE MASTER Work Packages-->
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="impg-odd-first" page-height="6.5in" page-width="9.5in">
	<xsl:choose>
						...
						<xsl:otherwise>
							...
							<fo:region-before extent="2pc" region-name="impg-before"/>
							<fo:region-after extent="2pc" region-name="xsl-region-after-odd"/>
						</xsl:otherwise>
					</xsl:choose>
	</fo:simple-page-master>
	<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="impg-even" page-height="6.5in" page-width="9.5in">
		<xsl:choose>
						<xsl:when test="*//@security = 'ts'">
								<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5.0pc" margin-top="4pc"/>
							<fo:region-before extent="5pc" region-name="impg-before"/>
	...
	<fo:simple-page-master margin-left=".75in" margin-right=".25in" margin-bottom=".5in" margin-top=".5in" master-name="impg-odd" page-height="6.5in" page-width="9.5in">
		<xsl:choose>
						<xsl:when test="*//@security = 'ts'">
								<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5.0pc" margin-top="4pc"/>
							<fo:region-before extent="5pc" region-name="impg-before"/>
...
<fo:simple-page-master margin-bottom=".25in" margin-left=".75in" margin-right=".25in" margin-top=".25in" master-name="emergpg-odd-first" page-height="6.5in" page-width="9.5in">
		<xsl:choose>
						<xsl:when test="*//@security = 'ts'">
							<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5.0pc" margin-top="4pc"/>
	...
	<fo:simple-page-master margin-bottom=".25in" margin-left=".25in" margin-right=".4in" margin-top=".15in" master-name="emergpg-even" page-height="6.5in" page-width="9.5in">
	<xsl:choose>
						<xsl:when test="*//@security = 'ts'">
								<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5.0pc" margin-top="4pc"/>
	...
	<fo:simple-page-master margin-left=".4in" margin-right=".25in" margin-bottom=".25in" margin-top=".15in" master-name="emergpg-odd" page-height="6.5in" page-width="9.5in">
<xsl:choose>
						<xsl:when test="*//@security = 'ts'">
							<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5.0pc" margin-top="4pc"/>
...
-->
	<fo:simple-page-master margin-bottom="2pc" margin-left="3pc" margin-right="6pc" margin-top="2pc" master-name="blank-page-even" page-height="6.5in" page-width="9.5in">
		<fo:region-body region-name="xsl-region-body-blank">
		</fo:region-body>
		<fo:region-after region-name="xsl-region-after-blank"/>
	</fo:simple-page-master>
	<fo:simple-page-master margin-bottom="2pc" margin-left="6pc" margin-right="3pc" margin-top="2pc" master-name="blank-page-odd" page-height="6.5in" page-width="9.5in">
		<fo:region-body region-name="xsl-region-body-blank">
		</fo:region-body>
		<fo:region-after region-name="xsl-region-after-blank"/>
	</fo:simple-page-master>
...
-->
	...
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="loepwppg-first" page-height="6.5in" page-width="9.5in" >
		<fo:region-body column-count="2" column-gap="10pt">
			<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+number($LOEPWP-SuperSize)+50"/>pt</xsl:attribute>
			<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+65"/>pt</xsl:attribute>
		</fo:region-body>
		<fo:region-before region-name="loepwppg-first-before">
			<xsl:attribute name="extent"><xsl:value-of select="number($SecurHeaderFooterSize)+number($LOEPWP-SuperSize)+30"/>pt</xsl:attribute>
		</fo:region-before>
		...
		<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="loepwppg-recto" page-height="6.5in" page-width="9.5in">
		<fo:region-body column-count="2" column-gap="10pt">
			<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+number($LOEPWP-SuperSize)+50"/>pt</xsl:attribute>
			<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+65"/>pt</xsl:attribute>
		</fo:region-body>
		...
		<fo:region-after display-align="before" region-name="xsl-region-after">
			<xsl:attribute name="extent"><xsl:value-of select="number($SecurHeaderFooterSize)+47"/>pt</xsl:attribute>
		</fo:region-after>
	</fo:simple-page-master>
	<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="loepwppg-verso" page-height="6.5in" page-width="9.5in">
			<fo:region-body column-count="2" column-gap="10pt">
			<xsl:attribute name="margin-top"><xsl:value-of select="number($SecurHeaderFooterSize)+number($LOEPWP-SuperSize)+50"/>pt</xsl:attribute>
			<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+65"/>pt</xsl:attribute>
		</fo:region-body>
		...
		<fo:region-after display-align="before" region-name="xsl-region-after-even">
			<xsl:attribute name="extent"><xsl:value-of select="number($SecurHeaderFooterSize)+47"/>pt</xsl:attribute>
		</fo:region-after>
	</fo:simple-page-master>
				<fo:simple-page-master margin-bottom="2pc" margin-left="6pc" margin-right="3pc" margin-top="2pc" master-name="bulkpage-first" page-height="9.5in" page-width="6.5in">
					<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5pc" margin-top="7pc"/>
					<fo:region-before extent="4pc" region-name="xsl-region-before-odd"/>
					<fo:region-after extent="2pc" region-name="xsl-region-after-odd"/>
				</fo:simple-page-master>
				<fo:simple-page-master margin-bottom="2pc" margin-left="3pc" margin-right="6pc" margin-top="2pc" master-name="bulk-impg-even" page-height="9.5in" page-width="6.5in">
					<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5pc" margin-top="7pc"/>
					<fo:region-before extent="5pc" region-name="xsl-region-before-even"/>
					<fo:region-after extent="2pc" region-name="xsl-region-after-even"/>
				</fo:simple-page-master>
				<fo:simple-page-master margin-bottom="2pc" margin-left="6pc" margin-right="3pc" margin-top="2pc" master-name="bulk-impg-odd" page-height="9.5in" page-width="6.5in">
					<fo:region-body column-count="2" column-gap="0.2in" margin-bottom="5pc" margin-top="7pc"/>
					<fo:region-before extent="5pc" region-name="xsl-region-before-odd"/>
					<fo:region-after extent="2pc" region-name="xsl-region-after-odd"/>
				</fo:simple-page-master>
...
-->
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="titlepage-first-recto" page-height="6.5in" page-width="9.5in">
		<fo:region-body margin-bottom="4pc" margin-top="0pc">
			<xsl:attribute name="margin-bottom"><xsl:value-of select="number($SecurHeaderFooterSize)+5"/>pt</xsl:attribute>
		</fo:region-body>
		<fo:region-after extent="8pc" region-name="titlepg-first-after"/>
	</fo:simple-page-master>
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="titlepage-recto" page-height="6.5in" page-width="9.5in">
		<fo:region-body margin-bottom="3pc" margin-top="0pc"/>
		<fo:region-after extent="4pc" region-name="xsl-region-after"/>
	</fo:simple-page-master>
	<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="titlepage-verso" page-height="6.5in" page-width="9.5in">
		<fo:region-body column-count="4" column-gap="4pt" margin-bottom="2pc" margin-top="2pc"/>
		<fo:region-after extent="2pc" region-name="xsl-region-after"/>
	</fo:simple-page-master>
	<!--
SIMPLE PAGE MASTER Cover
-->
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="tmcoverpg-recto-first" page-height="6.5in" page-width="9.5in">
		...
		<xsl:variable name="DisclosSize">
			...
			<xsl:choose>
				<xsl:when test="//frntcover/notices/disclos">62</xsl:when>
				<xsl:when test="//frntcover_abbreviated/notices/export">62</xsl:when>
				<xsl:otherwise>0</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
	...
	<xsl:value-of select="number($AvailSize)+number($SuperSize)+number($DisclosSize)+number($DistribSize)+number($ExportSize)+number($DestrSize)+number($SecurSize)+70"/>pt</xsl:variable>
	...
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="tmcoverpg-recto" page-height="6.5in" page-width="9.5in">
		<fo:region-body margin-bottom="1.5pc" margin-top="3pc"/>
		<fo:region-after extent="1.5pc" region-name="xsl-region-after"/>
	</fo:simple-page-master>
	<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="tmcoverpg-verso" page-height="9.5in" page-width="6.5in">
	<fo:region-body margin-bottom="1.5pc" margin-top="3pc"/>
		<fo:region-after extent="1.5pc" region-name="xsl-region-after"/>
	</fo:simple-page-master>
	<!--
...
-->
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="titleblkpg-recto-first" page-height="6.5in" page-width="9.5in">
		<xsl:variable name="AvailSize">
			<xsl:choose>
				<xsl:when test="//titleblk/notices/avail">12</xsl:when>
				<xsl:otherwise>0</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		<xsl:variable name="SuperSize">
			<xsl:choose>
				<xsl:when test="//titleblk/notices/super">12</xsl:when>
				<xsl:otherwise>0</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		<xsl:variable name="DisclosSize">
			<xsl:choose>
				<xsl:when test="//titleblk/notices/disclos">12</xsl:when>
				<xsl:otherwise>0</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		<xsl:variable name="DistribSize">
		...
		<xsl:variable name="ExportSize">
			<xsl:choose>
				<xsl:when test="//titleblk/notices/export">12</xsl:when>
				<xsl:otherwise>0</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		<xsl:variable name="DestrSize">
			<xsl:choose>
				<xsl:when test="//titleblk/notices/destr">12</xsl:when>
				<xsl:otherwise>0</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		<xsl:variable name="SecurSize">
			<xsl:choose>
				<xsl:when test="string-length($docsecr)>0">12</xsl:when>
				<xsl:otherwise>0</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		<xsl:variable name="CoverFooterSize">
			<xsl:value-of select="number($AvailSize)+number($SuperSize)+number($DisclosSize)+number($DistribSize)+number($ExportSize)+number($DestrSize)+number($SecurSize)+24"/>pt</xsl:variable>
		<fo:region-body margin-top="0pt">
			<xsl:attribute name="margin-bottom"><xsl:value-of select="$CoverFooterSize"/></xsl:attribute>
		</fo:region-body>
		<fo:region-after display-align="after" region-name="titleblkpg-first-after">
			<xsl:attribute name="extent"><xsl:value-of select="$CoverFooterSize"/></xsl:attribute>
		</fo:region-after>
	</fo:simple-page-master>
	
	<fo:simple-page-master margin-bottom=".5in" margin-left=".75in" margin-right=".25in" margin-top=".5in" master-name="titleblkpg-recto" page-height="6.5in" page-width="9.5in">
		<fo:region-body margin-bottom="1.5pc" margin-top="3pc"/>
		<fo:region-after extent="1.5pc" region-name="xsl-region-after"/>
	</fo:simple-page-master>
	<fo:simple-page-master margin-bottom=".5in" margin-left=".25in" margin-right=".75in" margin-top=".5in" master-name="titleblkpg-verso" page-height="6.5in" page-width="9.5in">
		<fo:region-body margin-bottom="1.5pc" margin-top="3pc"/>
		<fo:region-after extent="1.5pc" region-name="xsl-region-after"/>
	</fo:simple-page-master>
	<!--
...
25x11 Even Page
-->
	<fo:simple-page-master margin-bottom="2pc" margin-left="3pc" margin-right="6pc" margin-top="2pc" master-name="fo-25x11-even" page-height="6.5in" page-width="25in">
	<fo:region-before extent="5pc" region-name="xsl-region-before-fo"/>
		<fo:region-body margin-bottom="2pc" margin-top="2pc" region-name="xsl-region-body-fo"/>
		<fo:region-after extent="3pc" padding-top="1.5pc" region-name="xsl-region-after-fo"/>
	</fo:simple-page-master>
	<!--
25x11 Odd Page
-->
	<fo:simple-page-master margin-bottom="2pc" margin-left="6pc" margin-right="3pc" margin-top="2pc" master-name="fo-25x11-odd" page-height="6.5in" page-width="25in">
	<fo:region-before extent="5pc" region-name="xsl-region-before-fo"/>
		<fo:region-body margin-bottom="2pc" margin-top="2pc" region-name="xsl-region-body-fo"/>
		<fo:region-after extent="3pc" padding-top="1.5pc" region-name="xsl-region-after-fo"/>
	</fo:simple-page-master>
...
35x11 Even Page
-->
	<fo:simple-page-master margin-bottom="2pc" margin-left="3pc" margin-right="6pc" margin-top="2pc" master-name="fo-35x11-even" page-height="6.5in" page-width="35in">
			<fo:region-body margin-bottom="2pc" margin-top="2pc" region-name="blank-page-verso-after"/>
	</fo:simple-page-master>
	<!--
35x11 Odd Page
-->
	<fo:simple-page-master margin-bottom="2pc" margin-left="6pc" margin-right="3pc" margin-top="2pc" master-name="fo-35x11-odd" page-height="6.5in" page-width="35in">
				<fo:region-body margin-bottom="2pc" margin-top="2pc"/>
		<fo:region-after region-name="blank-page-recto-after"/>
	</fo:simple-page-master>
	<!--
45x11 Even Page
-->
	<fo:simple-page-master margin-bottom="2pc" margin-left="3pc" margin-right="6pc" margin-top="2pc" master-name="fo-45x11-even" page-height="6.5in" page-width="45in">
			<fo:region-body margin-bottom="2pc" margin-top="2pc" region-name="blank-page-verso-after"/>
	</fo:simple-page-master>
	<!--
45x11 Odd Page
-->
	<fo:simple-page-master margin-bottom="2pc" margin-left="6pc" margin-right="3pc" margin-top="2pc" master-name="fo-45x11-odd" page-height="6.5in" page-width="45in">
				<fo:region-body margin-bottom="2pc" margin-top="2pc"/>
		<fo:region-after region-name="blank-page-recto-after"/>
	</fo:simple-page-master>
	<!--
...
-->
	<fo:simple-page-master margin-bottom="2pc" margin-left="3pc" margin-right="6pc" margin-top="2pc" master-name="blank-page-even-fo" page-height="6.5in" page-width="25in" reference-orientation="90" writing-mode="rl-tb">
			<fo:region-body margin-bottom="2pc" margin-top="2pc"/>
		<fo:region-after region-name="blank-page-verso-after-fo"/>
	</fo:simple-page-master>
	<fo:simple-page-master margin-bottom="2pc" margin-left="6pc" margin-right="3pc" margin-top="2pc" master-name="blank-page-odd-fo" page-height="6.5in" page-width="25in" reference-orientation="90" writing-mode="rl-tb">
			<fo:region-body margin-bottom="2pc" margin-top="2pc"/>
		<fo:region-after region-name="blank-page-recto-after-fo"/>
	</fo:simple-page-master>
...
-->
	<fo:simple-page-master margin-bottom="2pc" margin-left="3pc" margin-right="6pc" margin-top="2pc" master-name="landscape-even" page-height="8.5in" page-width="11in">
		...
		<fo:region-before extent="5pc" region-name="xsl-region-before-fo"/>
		<fo:region-after extent="3pc" padding-top="1.5pc" region-name="xsl-region-after-land"/>
	</fo:simple-page-master>
	<!--
landscape Odd Page
-->
	<fo:simple-page-master margin-bottom="2pc" margin-left="6pc" margin-right="3pc" margin-top="2pc" master-name="landscape-odd" page-height="6.5in" page-width="9.5in">
		<fo:region-body margin-bottom="2pc" margin-top="2pc" region-name="xsl-region-body-land"/>
		<fo:region-before extent="5pc" region-name="xsl-region-before-fo"/>
		<fo:region-after extent="3pc" padding-top="1.5pc" region-name="xsl-region-after-land"/>
	</fo:simple-page-master>	
...
<xsl:template name="substring-after-last"> 
	...
	<xsl:include href="chapter_titlepg-v6_0.xsl"/>
	<xsl:include href="contents-v6_0.xsl"/>
	<xsl:include href="pageset-templ-v6_0.xsl"/>
	<xsl:include href="common-templ-v6_0.xsl"/>
	<xsl:include href="aalwp-v6_0.xsl"/>
	<xsl:include href="cmwp-v6_0.xsl"/>
	<xsl:include href="para-seqlist-step-v6_0.xsl"/>
	<xsl:include href="alert-templ-v6_0.xsl"/>
	<xsl:include href="ammo.markingwp-v6_0.xsl"/>
	<xsl:include href="ammowp-v6_0.xsl"/>
	<xsl:include href="auxeqpwp-v6_0.xsl"/>
	<xsl:include href="damage-assesswp-v6_0.xsl"/>
	<xsl:include href="bdar_geninfowp-v6_0.xsl"/>
	<xsl:include href="bulk_itemswp-v6_0.xsl"/>
	<xsl:include href="table-v6_0.xsl"/>
	<xsl:include href="chgsheet-v6_0.xsl"/>
	<xsl:include href="coeibiiwp-v6_0.xsl"/>
	<xsl:include href="compchklistwp-v6_0.xsl"/>
	<xsl:include href="csi.wp-v6_0.xsl"/>
	<xsl:include href="ctrlindwp-v6_0.xsl"/>
	<xsl:include href="descwp-v6_0.xsl"/>
	<xsl:include href="destruct_introwp-v6_0.xsl"/>
	<xsl:include href="destruct_materialwp-v6_0.xsl"/>
	<xsl:include href="distribution-v6_0.xsl"/>
	<xsl:include href="pi-v6_0.xsl"/>
	<xsl:include href="dmwr_ammo-v6_0.xsl"/>
	<xsl:include href="emergencywp-v6_0.xsl"/>
	<xsl:include href="eqploadwp-v6_0.xsl"/>
	<xsl:include href="explistwp-v6_0.xsl"/>
	<xsl:include href="facilwp-v6_0.xsl"/>
	<xsl:include href="frntcover-v6_0.xsl"/>
	<xsl:include href="figure-graphic-v6_0.xsl"/>
	<xsl:include href="genwp-v6_0.xsl"/>
	<xsl:include href="ginfowp-v6_0.xsl"/>
	<xsl:include href="genmaint_ginfowp-v6_0.xsl"/>
	<xsl:include href="introwp-v6_0.xsl"/>
	<xsl:include href="inventorywp-v6_0.xsl"/>
	<xsl:include href="loepwp-v6_0.xsl"/>
	<xsl:include href="lubeorder-pageset-templ-v6_0.xsl"/>
	<xsl:include href="lubetypeswp-v6_0.xsl"/>
	<xsl:include href="lubricantsymbolwp-v6_0.xsl"/>
	<xsl:include href="lospecnoteswp-v6_0.xsl"/>
	<xsl:include href="lubewp-v6_0.xsl"/>
	<xsl:include href="macintrowp-v6_0.xsl"/>
	<xsl:include href="macwp-v6_0.xsl"/>
	<xsl:include href="maintwp-v6_0.xsl"/>
	<xsl:include href="manuwp-v6_0.xsl"/>
	<xsl:include href="manu_items_introwp-v6_0.xsl"/>
	<xsl:include href="mim-v6_0.xsl"/>
	<xsl:include href="brim-v6_0.xsl"/>
	<xsl:include href="mobilwp-v6_0.xsl"/>
	<xsl:include href="mrplwp-v6_0.xsl"/>
	<xsl:include href="natowp-v6_0.xsl"/>
	<xsl:include href="nsnindxwp-v6_0.xsl"/>
	<xsl:include href="oipwp-v6_0.xsl"/>
	<xsl:include href="opcheck-tswp-v6_0.xsl"/>
	<xsl:include href="opcheckwp-v6_0.xsl"/>
	<xsl:include href="opunuwp-v6_0.xsl"/>
	<xsl:include href="opusualwp-v6_0.xsl"/>
	<xsl:include href="pim-v6_0.xsl"/>
	<xsl:include href="perseqpwp-v6_0.xsl"/>
	<xsl:include href="plwp-v6_0.xsl"/>
	<xsl:include href="pmcsintrowp-v6_0.xsl"/>
	<xsl:include href="pmcswp-v6_0.xsl"/>
	<xsl:include href="pm-ginfowp-v6_0.xsl"/>
	<xsl:include href="pmi-cklistwp-v6_0.xsl"/>
	<xsl:include href="pmiwp-v6_0.xsl"/>
	<xsl:include href="pms-ginfowp-v6_0.xsl"/>
	<xsl:include href="pms-inspecwp-v6_0.xsl"/>
	<xsl:include href="pnindxwp-v6_0.xsl"/>
	<xsl:include href="pshopanalwp-v6_0.xsl"/>
	<xsl:include href="qawp-v6_0.xsl"/>
	<xsl:include href="rear-templ-v6_0.xsl"/>
	<xsl:include href="refwp-v6_0.xsl"/>
	<xsl:include href="refdesindxwp-v6_0.xsl"/>
	<xsl:include href="stlwp-v6_0.xsl"/>
	<xsl:include href="storagewp-v6_0.xsl"/>
	<xsl:include href="stowagewp-v6_0.xsl"/>
	<xsl:include href="supitemwp-v6_0.xsl"/>
	<xsl:include href="surwp-v6_0.xsl"/>
	<xsl:include href="techdescwp-v6_0.xsl"/>
	<xsl:include href="tim-v6_0.xsl"/>
	<xsl:include href="thrywp-v6_0.xsl"/>
	<xsl:include href="titleblk-v6_0.xsl"/>
	<xsl:include href="toolidwp-v6_0.xsl"/>
	<xsl:include href="torquewp-v6_0.xsl"/>
	<xsl:include href="tsindxwp-v6_0.xsl"/>
	<xsl:include href="tsintrowp-v6_0.xsl"/>
	<xsl:include href="tswp-v6_0.xsl"/>
	<xsl:include href="warnsum-v6_0.xsl"/>
	<xsl:include href="wiringwp-v6_0.xsl"/>
	<xsl:include href="wpidinfo-templ-v6_0.xsl"/>
	<xsl:include href="initial_setup-templ-v6_0.xsl"/>
	<xsl:include href="wtloadwp-v6_0.xsl"/>
	<xsl:include href="xrefs-v6_0.xsl"/>
	<xsl:include href="bim-v6_0.xsl"/>
	<xsl:include href="genrepairwp-v6_0.xsl"/>
	<xsl:include href="substitute-matwp-v6_0.xsl"/>
	<xsl:include href="bdartoolswp-v6_0.xsl"/>
	<xsl:include href="pmc-table-v6_0.xsl"/>
	<xsl:include href="orschwp-v6_0.xsl"/>
	<xsl:include href="basicpara-v6_0.xsl"/>
	<xsl:include href="handreceiptwp-v6_0.xsl"/>
	<xsl:include href="sopim-v6_0.xsl"/>
	<xsl:include href="softpowerdownwp-v6_0.xsl"/>
	<xsl:include href="softpowerupwp-v6_0.xsl"/>
	<xsl:include href="softsuperctrlswp-v6_0.xsl"/> 
	<xsl:include href="softsecprivwp-v6_0.xsl"/> 
	<xsl:include href="softgenwp-v6_0.xsl"/>
	<xsl:include href="softopconventionswp-v6_0.xsl"/>
	<xsl:include href="softguiwp-v6_0.xsl"/>
	<xsl:include href="softproccmdwp-v6_0.xsl"/>
	<xsl:include href="softaccesswp-v6_0.xsl"/>
<xsl:include href="softkeycmdswp-v6_0.xsl"/>


	<xsl:include href="softdescdata-v6_0.xsl"/>
	<xsl:include href="softdiffversionwp-v6_0.xsl"/>
	<xsl:include href="softginfowp-v6_0.xsl"/>
	<xsl:include href="softsumwp-v6_0.xsl"/>
	<xsl:include href="softeffectwp-v6_0.xsl"/>
	<xsl:include href="softerrorswp-v6_0.xsl"/>
	<xsl:include href="softfeaturescapwp-v6_0.xsl"/>
	

	
	
	
	<xsl:include href="softscreendisplaywp-v6_0.xsl"/> 
	<xsl:include href="softmenuwp-v6_0.xsl"/>
	<xsl:include href="softtoolswp-v6_0.xsl"/>
	<xsl:include href="softmessageswp-v6_0.xsl"/>
<!--	<xsl:include href="sam-v6_0.xsl"/>
	<xsl:include href="sum-v6_0.xsl"/>-->
	<!--<xsl:include href="chapter_titlepg-v5_0_LogLand.xsl"/>
	<xsl:include href="aalwp-v5_0_LogLand.xsl"/>
	<xsl:include href="alert-templ-v5_0_LogLand.xsl"/>
	<xsl:include href="pageset-templ-v5_0_LogLand.xsl"/>
	<xsl:include href="para-seqlist-step-v5_0_LogLand.xsl"/>
	<xsl:include href="ammo.markingwp-v5_0_LogLand.xsl"/>
	<xsl:include href="ammowp-v5_0_LogLand.xsl"/>
	<xsl:include href="auxeqpwp-v5_0_LogLand.xsl"/>
	<xsl:include href="damage-assesswp-v5_0_LogLand.xsl"/>
	<xsl:include href="bdar_geninfowp-v5_0_LogLand.xsl"/>
	<xsl:include href="bim-v5_0_LogLand.xsl"/>
	<xsl:include href="brim-v5_0_LogLand.xsl"/>
	<xsl:include href="genrepairwp-v5_0_LogLand.xsl"/>
	<xsl:include href="substitute-matwp-v5_0_LogLand.xsl"/>
	<xsl:include href="bdartoolswp-v5_0_LogLand.xsl"/>
	<xsl:include href="bulk_itemswp-v5_0_LogLand.xsl"/>
	<xsl:include href="chgsheet-v5_0_LogLand.xsl"/>
	<xsl:include href="coeibiiwp-v5_0_LogLand.xsl"/>
	<xsl:include href="common-templ-v5_0_LogLand.xsl"/>
	<xsl:include href="compchklistwp-v5_0_LogLand.xsl"/>
	<xsl:include href="contents-v5_0_LogLand.xsl"/>
	<xsl:include href="csi.wp-v5_0_LogLand.xsl"/>
	<xsl:include href="ctrlindwp-v5_0_LogLand.xsl"/>
	<xsl:include href="descwp-v5_0_LogLand.xsl"/>
	<xsl:include href="destruct_materialwp-v5_0_LogLand.xsl"/>
	<xsl:include href="destruct-ginfowp-v5_0_LogLand.xsl"/>
	<xsl:include href="distribution-v5_0_LogLand.xsl"/>
	<xsl:include href="emergencywp-v5_0_LogLand.xsl"/>
	<xsl:include href="eqploadwp-v5_0_LogLand.xsl"/>
	<xsl:include href="explistwp-v5_0_LogLand.xsl"/>
	<xsl:include href="facilwp-v5_0_LogLand.xsl"/>
	<xsl:include href="frntcover-v5_0_LogLand.xsl"/>
	<xsl:include href="figure-graphic-v5_0_LogLand.xsl"/>
	<xsl:include href="genwp-v5_0_LogLand.xsl"/>
	<xsl:include href="ginfowp-v5_0_LogLand.xsl"/>
	<xsl:include href="introwp-v5_0_LogLand.xsl"/>
	<xsl:include href="inventorywp-v5_0_LogLand.xsl"/>
	<xsl:include href="kitswp-v5_0_LogLand.xsl"/>
	<xsl:include href="loepwp-v5_0_LogLand.xsl"/>
	<xsl:include href="lubewp-v5_0_LogLand.xsl"/>
	<xsl:include href="macintrowp-v5_0_LogLand.xsl"/>
	<xsl:include href="macwp-v5_0_LogLand.xsl"/>
	<xsl:include href="maintwp-v5_0_LogLand.xsl"/>
	<xsl:include href="manuwp-v5_0_LogLand.xsl"/>
	<xsl:include href="manu_items_introwp-v5_0_LogLand.xsl"/>
	<xsl:include href="mim-v5_0_LogLand.xsl"/>
	<xsl:include href="mobilwp-v5_0_LogLand.xsl"/>
	<xsl:include href="mrplwp-v5_0_LogLand.xsl"/>
	<xsl:include href="natowp-v5_0_LogLand.xsl"/>
	<xsl:include href="nsnindxwp-v5_0_LogLand.xsl"/>
	<xsl:include href="oipwp-v5_0_LogLand.xsl"/>
	<xsl:include href="opcheck-tswp-v5_0_LogLand.xsl"/>
	<xsl:include href="opcheckwp-v5_0_LogLand.xsl"/>
	<xsl:include href="opunuwp-v5_0_LogLand.xsl"/>
	<xsl:include href="opusualwp-v5_0_LogLand.xsl"/>
	<xsl:include href="pim-v5_0_LogLand.xsl"/>
	<xsl:include href="perseqpwp-v5_0_LogLand.xsl"/>
	<xsl:include href="plwp-v5_0_LogLand.xsl"/>
	<xsl:include href="pi-v5_0_LogLand.xsl"/>
	<xsl:include href="pmcsintrowp-v5_0_LogLand.xsl"/>
	<xsl:include href="pmcswp-v5_0_LogLand.xsl"/>
	<xsl:include href="pm-v5_0_LogLand.xsl"/>
	<xsl:include href="pm-ginfowp-v5_0_LogLand.xsl"/>
	<xsl:include href="pmi-cklistwp-v5_0_LogLand.xsl"/>
	<xsl:include href="pmiwp-v5_0_LogLand.xsl"/>
	<xsl:include href="pms-ginfowp-v5_0_LogLand.xsl"/>
	<xsl:include href="pms-inspecwp-v5_0_LogLand.xsl"/>
	<xsl:include href="pnindxwp-v5_0_LogLand.xsl"/>
	<xsl:include href="pshopanalwp-v5_0_LogLand.xsl"/>
	<xsl:include href="qawp-v5_0_LogLand.xsl"/>
	<xsl:include href="rear-templ-v5_0_LogLand.xsl"/>
	<xsl:include href="refwp-v5_0_LogLand.xsl"/>
	<xsl:include href="refdesindxwp-v5_0_LogLand.xsl"/>
	<xsl:include href="rpstlwp-v5_0_LogLand.xsl"/>
	<xsl:include href="stlwp-v5_0_LogLand.xsl"/>
	<xsl:include href="storagewp-v5_0_LogLand.xsl"/>
	<xsl:include href="stowagewp-v5_0_LogLand.xsl"/>
	<xsl:include href="supitemwp-v5_0_LogLand.xsl"/>
	<xsl:include href="surwp-v5_0_LogLand.xsl"/>
	<xsl:include href="table-v5_0_LogLand.xsl"/>
	<xsl:include href="techdescwp-v5_0_LogLand.xsl"/>
	<xsl:include href="tim-v5_0_LogLand.xsl"/>
	<xsl:include href="thrywp-v5_0_LogLand.xsl"/>
	<xsl:include href="titleblk-v5_0_LogLand.xsl"/>
	<xsl:include href="toolidwp-v5_0_LogLand.xsl"/>
	<xsl:include href="torquewp-v5_0_LogLand.xsl"/>
	<xsl:include href="tsindxwp-v5_0_LogLand.xsl"/>
	<xsl:include href="tsintrowp-v5_0_LogLand.xsl"/>
	<xsl:include href="tswp-v5_0_LogLand.xsl"/>
	<xsl:include href="warnsum-v5_0_LogLand.xsl"/>
	<xsl:include href="wiringwp-v5_0_LogLand.xsl"/>
	<xsl:include href="wpidinfo-templ-v5_0_LogLand.xsl"/>
	<xsl:include href="wpinfo-templ-v5_0_LogLand.xsl"/>
	<xsl:include href="wtloadwp-v5_0_LogLand.xsl"/>
	<xsl:include href="xrefs-v5_0_LogLand.xsl"/>-->
